...
function NewPostPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.log(err);
      setError(err.response?.data?.message || "An error occurred while submitting your post");
      setLoading(false);
    }
  };
  ...
  if (success) {
    return (
      <div className="newPostPage successPage">
        <div className="successMessage">
          <h2>Your post has been submitted successfully!</h2>
          <p>It is now pending admin verification. Once approved, it will be visible on the site.</p>
